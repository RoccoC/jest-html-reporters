...
const columns = [
  ...
  },
  {
    ...
    title: 'action',
    key: 'operation',
    render: ({ failureMessages, fullName, fileAttachInfos, subGroups, logs }) => !subGroups && <ErrorButton caseAttachInfos={fileAttachInfos[fullName]} failureMessage={failureMessages[0]} logs={logs} />
  }
]
